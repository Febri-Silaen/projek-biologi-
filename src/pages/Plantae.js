      ...
      <Row className="align-items-center gy-4">
        ...
        <Col md={6}>
          <Card className="shadow plant-card">
            <Card.Img
              variant="top"
              src="./assets/images/kingdom-plantae.jpg"
              alt="Kingdom Plantae"
            ...
            <Card.Body>
              ...
              <Link to="/plantae-details" className="btn btn-success">
        ...
        <Col md={4}>
          <Link to="/pteridophyta" className="text-decoration-none">
            <Card className="shadow plant-class-card">
              <Card.Img
                variant="top"
                src="./assets/images/pteridophyta.jpg"
                alt="Pteridophyta"
                className="img-fluid"
              />
              <Card.Body>
        ...
        <Col md={4}>
          <Link to="/bryophyta" className="text-decoration-none">
            <Card className="shadow plant-class-card">
              <Card.Img
                variant="top"
                src="./assets/images/bryophyta.jpg"
                alt="Bryophyta"
                className="img-fluid"
              />
              <Card.Body>
        ...
        <Col md={4}>
          <Link to="/spermatophyta" className="text-decoration-none">
            <Card className="shadow plant-class-card">
              <Card.Img
                variant="top"
                src="./assets/images/spermatophyta.jpg"
                alt="Spermatophyta"
                className="img-fluid"
              />
              <Card.Body>
