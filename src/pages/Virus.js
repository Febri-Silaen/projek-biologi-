  ...
  return (
    ...
    <div className="card-wrapper">
      ...
      <p className="text-description">
        ...
        <p><strong>a. Adolf Meyer.</strong>  
        Pada tahun 1883, Adolf Meyer, seorang ilmuwan Jerman mengamati penyakit yang menyebabkan adanya bintik-bintik kuning pada daun tembakau. Meyer kemudian melakukan percobaan dengan menyemprotkan getah yang diekstraksi dari tanaman tembakau yang sakit ke tanaman tembakau yang sehat. 
        ...
        <p><strong>b. Dmitri Ivanovsky.</strong>  
        ...
        <p><strong>c. Martinus Beijerinck.</strong> 
        ...
        <p><strong>d. Wendell Meredith Stanley.</strong> 
        Pada tahun 1935, Wendell Meredith Stanley, seorang ilmuwan Amerika berhasil mengkristalkan partikel penyebab penyakit pada tanaman tembakau. Penyakit ini kemudian dikenal dengan nama Tobacco Mosaic Virus (TMV).</p>
      </div>  
